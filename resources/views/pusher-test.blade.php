...
<body>
    ...
    <script>
        ...
        function addJobCard(eventName, data) {
            ...
            card.innerHTML = `
                ...
                <div class="job-info-grid">
                    <div>
                        ...
                        <div class="info-value">${data.budget || 'Not specified'} ${data.hourly_rate ? '(Hourly)' : '(Fixed)'}</div>
                    </div>
                    <div>
                ...
                <div class="ai-section">
                    <div class="ai-summary">${data.reasoning || 'AI analysis not available'}</div>
                    <div class="ai-score">
                        <span class="stars">${stars}</span>
                        <span class="score-value">${data.ai_score || 0}/100</span>
                        <span class="recommendation">${data.recommendation || 'CONSIDER'}</span>
                    </div>
                </div>
            ...
            showDesktopNotification(data.emoji + ' ' + (data.title || 'New Job'), `AI Score: ${data.ai_score}/100 - ${data.recommendation}`);
        }
        ...
        function testPusherConnection() {
            ...
            const testData = {
                ...
                reasoning: 'This is a test notification to verify the Pusher dashboard is receiving events correctly.',
